...
export function AuthScreen({ redirectUrl, signupRestricted = false }: AuthScreenProps) {
  return (
    <main className="relative grid min-h-svh place-items-center overflow-hidden bg-background px-4 py-10">
      ...
      >
        ...
        <footer className="flex items-center gap-2 text-sm text-muted-foreground/50">
